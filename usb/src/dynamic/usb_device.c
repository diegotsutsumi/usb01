...
)
{
    ...
    //TODO: Add code to check error returned from OSAL.
...
)
{
    ...
    {
        //TODO: Add code to check the error returned from OSAL
...
void _USB_DEVICE_RedirectControlXfrToClient (USB_DEVICE_OBJ* usbDeviceThisInstance ,
