...
/* standard USB configdescripror size */
...
/* Dynamic allocation of memmory */
#define      USB_HOST_MALLOC(size)       malloc(size)
/* Free memory */
#define      USB_HOST_FREE(ptr)          free(ptr)
// *****************************************************************************
/*  USB Host Class Driver Funtion Pointer Structure.
...
typedef struct _USB_HOST_CLASS_DRIVER
{
    ...
    /* Pointer to the Class Driver Deintialize function */
...
/*  USB Host Endpoint Information
  ...
  Description:
    This data stucture contains information about the endpoint of an attached
...
{
    /* Standard USB Interface desctiptor */
...
/*  USB Host Interface Descriptor Information.
  ...
  Summary:
    USB Host Inteface Descriptor Information.
...
typedef struct  _USB_HOST_OBJ_
{
    ...
    EnumCompletedHandle     enumCompHandle; //Tsutsumi's Patch
...
/*  USB Host Layer Device State Constants
  ...
  Description:
    These are defintions of USB Host Device State Masks contstants
